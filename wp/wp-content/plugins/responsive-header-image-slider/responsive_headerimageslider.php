...
function sp_responsiveslider_setup_post_types() {
	...
	$responsiveslider_labels =  apply_filters( 'sp_responsiveslider_labels', array(
		...
		'add_new'             => __('Adicionar', 'sp_responsiveslider'),

		'add_new_item'        => __('Adicionar Imagem', 'sp_responsiveslider'),

		'edit_item'           => __('Editar Imagem', 'sp_responsiveslider'),

		'new_item'            => __('Adicionar Novo', 'sp_responsiveslider'),

		'all_items'           => __('Todos os Slides', 'sp_responsiveslider'),

		'view_item'           => __('Vizualizar Imagem', 'sp_responsiveslider'),

		'search_items'        => __('Procurar Imagem', 'sp_responsiveslider'),
		...
		'menu_name'           => __('Slideshow', 'sp_responsiveslider'),
